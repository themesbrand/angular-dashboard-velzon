...
@Component({
  selector: 'app-view-cv-section-form',
  templateUrl: './view-cv-section-form.component.html',
  styleUrls: ['./view-cv-section-form.component.scss']
})
export class ViewCvSectionFormComponent implements OnInit {

...
@Component({
  selector: 'app-application-for-fellowship',
  templateUrl: './application-for-fellowship.component.html',
  styleUrls: ['./application-for-fellowship.component.scss']
})
export class ApplicationForFellowshipComponent implements OnInit {

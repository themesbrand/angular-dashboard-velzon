...
@Component({
  selector: 'app-id-cards-requests',
  templateUrl: './id-cards-requests.component.html',
  styleUrls: ['./id-cards-requests.component.scss'],
  animations: [
    trigger(
      'enterAnimation', [
        transition(':enter', [
...
export class IdCardsRequestsComponent implements OnInit {

...
@Component({
  selector: 'app-graduation-form-request',
  templateUrl: './graduation-form-request.component.html',
  styleUrls: ['./graduation-form-request.component.scss']
})
export class GraduationFormRequestComponent implements OnInit {

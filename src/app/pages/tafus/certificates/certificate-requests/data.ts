const data = {
    tableData : [
        {
            ...
            certificateType : 'Replacement for OMSB Certificates',
        ...
        },
        {
            ...
            traineeName : 'Madan Khan',
            submitDate : '2022-07-25',
            certificateType : 'Certified True Copy of the Original',
            reason: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptate magni mollitia iure eligendi suscipit laudantium.',
            fees: '100',
    ...
    purposeOfLetters : [
        {
            name : 'Replacement for OMSB Certificates',
            fee : '150'
        },
        {
            name : 'Certified True Copy of the Original',
            fee : '100'
        }
    ]

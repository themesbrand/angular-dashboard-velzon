...
@Component({
  selector: 'app-view-new-member-request',
  templateUrl: './view-new-member-request.component.html',
  styleUrls: ['./view-new-member-request.component.scss']
})
export class ViewNewMemberRequestComponent implements OnInit {

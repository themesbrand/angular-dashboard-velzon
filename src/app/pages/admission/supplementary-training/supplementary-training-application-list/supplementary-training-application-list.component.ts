...
@Component({
  selector: 'app-supplementary-training-application-list',
  templateUrl: './supplementary-training-application-list.component.html',
  styleUrls: ['./supplementary-training-application-list.component.scss'],
  animations: [
    trigger(
      'enterAnimation', [
        transition(':enter', [
...
export class SupplementaryTrainingApplicationListComponent implements OnInit {

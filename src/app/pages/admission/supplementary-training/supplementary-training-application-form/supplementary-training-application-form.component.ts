...
@Component({
  selector: 'app-supplementary-training-application-form',
  templateUrl: './supplementary-training-application-form.component.html',
  styleUrls: ['./supplementary-training-application-form.component.scss']
})
export class SupplementaryTrainingApplicationFormComponent implements OnInit {
  ...
  applicationFormInit() {
    this.applicationForm = this.formBuilder.group({
      ...
      oneYearSupplementaryTraining : new FormControl(null, []),

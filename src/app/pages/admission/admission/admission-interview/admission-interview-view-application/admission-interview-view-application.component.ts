...
@Component({
  selector: 'app-admission-interview-view-application',
  templateUrl: './admission-interview-view-application.component.html',
  styleUrls: ['./admission-interview-view-application.component.scss']
})

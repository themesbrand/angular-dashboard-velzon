    ...
    applicationTableDate : [
        {
            ...
            action: 'red',
            applicationStatus : [
              { stage : 'Applied', status : 'Submit', date : '2022-05-06', by : 'Madan Al Abri'},
        ...
        },
        {
            ...
            action: 'green',
            applicationStatus : [
              { stage : 'Applied', status : 'Submit', date : '2022-05-06', by : 'Saleh Mahfoudh'},
              { stage : 'Shortlisted for Interview', status : 'Submit', date : '2022-05-10', by : 'Abdel Maddali'}
            ]
        },
        {
            fullName : 'Madan Khan',
            ...
            action: 'red',
            applicationStatus : [
              { stage : 'Applied', status : 'Submit', date : '2022-05-06', by : 'Madan Khan'},

...
@Component({
  selector: 'app-interruption-view-applications',
  templateUrl: './interruption-view-applications.component.html',
  styleUrls: ['./interruption-view-applications.component.scss'],
  animations: [
    trigger(
      'enterAnimation', [
        transition(':enter', [
...
export class InterruptionViewApplicationsComponent implements OnInit {

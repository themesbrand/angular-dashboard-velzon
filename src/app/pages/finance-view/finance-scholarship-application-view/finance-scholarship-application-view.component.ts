...
@Component({
  selector: 'app-finance-scholarship-application-view',
  templateUrl: './finance-scholarship-application-view.component.html',
  styleUrls: ['./finance-scholarship-application-view.component.scss']
})
export class FinanceScholarshipApplicationViewComponent implements OnInit {

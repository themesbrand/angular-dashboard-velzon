...
@Component({
  selector: 'app-create-exam-dates',
  templateUrl: './create-exam-dates.component.html',
  styleUrls: ['./create-exam-dates.component.scss']
})
export class CreateExamDatesComponent implements OnInit {
  examDateData: any;
  ...
  createExamFormInit() {
    this.createExamDatesForm = this.formBuilder.group({
      ...
      startDateOfApplication: new FormControl(null, []),

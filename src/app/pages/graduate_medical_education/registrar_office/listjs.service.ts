...
function matches(country: ListJsModel, term: string, pipe: PipeTransform) {
  return country.studentName.toLowerCase().includes(term.toLowerCase())
  || country.college.toLowerCase().includes(term.toLowerCase())
  || country.program.toLowerCase().includes(term.toLowerCase())
  || country.studentRollNumber.toLowerCase().includes(term.toLowerCase())
  || country.intakeYear.toLowerCase().includes(term.toLowerCase());

...
@Component({
  selector: 'app-application-international-trainee',
  templateUrl: './application-international-trainee.component.html',
  styleUrls: ['./application-international-trainee.component.scss']
})
export class ApplicationInternationalTraineeComponent implements OnInit {

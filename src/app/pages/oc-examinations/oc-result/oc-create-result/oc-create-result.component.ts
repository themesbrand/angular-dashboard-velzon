...
@Component({
  selector: 'app-oc-create-result',
  templateUrl: './oc-create-result.component.html',
  styleUrls: ['./oc-create-result.component.scss']
})
export class OcCreateResultComponent implements OnInit {

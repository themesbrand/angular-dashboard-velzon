...
@Component({
  selector: 'app-evaluation-form-oral-presentation',
  templateUrl: './evaluation-form-oral-presentation.component.html',
  styleUrls: ['./evaluation-form-oral-presentation.component.scss']
})
export class EvaluationFormOralPresentationComponent implements OnInit {

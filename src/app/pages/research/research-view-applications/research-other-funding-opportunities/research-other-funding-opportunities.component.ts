...
@Component({
  selector: 'app-research-other-funding-opportunities',
  templateUrl: './research-other-funding-opportunities.component.html',
  styleUrls: ['./research-other-funding-opportunities.component.scss'],
  animations: [
    trigger(
      'enterAnimation', [
        transition(':enter', [
...
export class ResearchOtherFundingOpportunitiesComponent implements OnInit {

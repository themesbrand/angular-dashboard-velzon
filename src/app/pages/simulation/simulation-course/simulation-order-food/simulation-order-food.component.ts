...
@Component({
  selector: 'app-simulation-order-food',
  templateUrl: './simulation-order-food.component.html',
  styleUrls: ['./simulation-order-food.component.scss'],
  animations: [
    trigger(
      'enterAnimation', [
        transition(':enter', [
...
export class SimulationOrderFoodComponent implements OnInit {

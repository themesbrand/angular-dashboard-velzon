...
@Component({
  selector: 'app-create-simulation-facilities-for-rent',
  templateUrl: './create-simulation-facilities-for-rent.component.html',
  styleUrls: ['./create-simulation-facilities-for-rent.component.scss']
})
export class CreateSimulationFacilitiesForRentComponent implements OnInit {

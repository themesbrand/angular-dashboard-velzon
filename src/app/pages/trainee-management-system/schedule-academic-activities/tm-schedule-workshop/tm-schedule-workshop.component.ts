...
@Component({
  selector: 'app-tm-schedule-workshop',
  templateUrl: './tm-schedule-workshop.component.html',
  styleUrls: ['./tm-schedule-workshop.component.scss']
})
export class TmScheduleWorkshopComponent implements OnInit {

const data = {
    tableData : [
        { rotation: 'Anesthesia for General Surgery ', R1 : '1', R2 : '', R3: '1', R4 : '1', R5 : ''},
        { rotation: 'Anesthesia for General Surgery - Ambulatory Cases', R1 : '0.5', R2 : '', R3: '', R4 : '', R5 : '2'},
        { rotation: 'Anesthesia for General Surgery – Urology Surgery ', R1 : '', R2 : '4', R3: '', R4 : '1.5', R5 : ''},
        { rotation: 'Anesthesia for General Surgery – Vascular Surgery', R1 : '1', R2 : '', R3: '', R4 : '2', R5 : ''},
        { rotation: 'Anesthesia for ENT/Ophthalmology/ Oral & Maxillofacial Surgery', R1 : '', R2 : '4', R3: '', R4 : '0.5', R5 : ''},
        { rotation: 'Obstetrics and Gynecology Anesthesia', R1 : '1', R2 : '', R3: '', R4 : '', R5 : '2.5'},
        { rotation: 'Regional Anesthesia ', R1 : '2', R2 : '', R3: '', R4 : '1.5', R5 : ''},
        { rotation: 'Anesthesia for Orthopedic Surgery', R1 : '', R2 : '', R3: '', R4 : '', R5 : ''},
        { rotation: 'Pre-Anesthesia Clinic (PAC)', R1 : '0.5', R2 : '0.5', R3: '0.5', R4 : '1', R5 : '2'},
        { rotation: 'Critical Care Medicine', R1 : '', R2 : '2', R3: '', R4 : '', R5 : ''},
        { rotation: 'Plastic Surgery & Burns Anesthesia', R1 : '', R2 : '', R3: '', R4 : '', R5 : '1'},
        { rotation: 'Pain Management', R1 : '', R2 : '', R3: '2.5', R4 : '', R5 : ''},
        { rotation: 'Postanesthesia Care Unit- (PACU) 2 week', R1 : '', R2 : '', R3: '', R4 : '', R5 : '1'},
        { rotation: 'Pediatric Anesthesia', R1 : '', R2 : '', R3: '1', R4 : '1', R5 : ''},
        { rotation: 'Neurosurgical Anesthesia', R1 : '', R2 : '1', R3: '', R4 : '0.5', R5 : ''},
        { rotation: 'Cardio Thoracic Anesthesia', R1 : '1', R2 : '', R3: '1', R4 : '', R5 : ''},
        { rotation: 'Anesthesia for Radiodiagnosis/Remote Location', R1 : '2', R2 : '', R3: '1', R4 : '', R5 : '1'},
        { rotation: 'Respiratory Medicine', R1 : '0.5', R2 : '', R3: '1.5', R4 : '', R5 : '1'},
        { rotation: 'Coronary Care Unit', R1 : '2', R2 : '', R3: '1.5', R4 : '', R5 : ''},
        { rotation: 'Research', R1 : '0.5', R2 : '', R3: '1', R4 : '1', R5 : ''},
        { rotation: 'Elective', R1 : '', R2 : '0.5', R3: '1', R4 : '2', R5 : '1.5'},

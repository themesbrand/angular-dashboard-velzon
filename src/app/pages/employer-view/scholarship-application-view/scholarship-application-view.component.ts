...
@Component({
  selector: 'app-scholarship-application-view',
  templateUrl: './scholarship-application-view.component.html',
  styleUrls: ['./scholarship-application-view.component.scss']
})
export class ScholarshipApplicationViewComponent implements OnInit {

...
@Component({
  selector: 'app-view-interviewer-result',
  templateUrl: './view-interviewer-result.component.html',
  styleUrls: ['./view-interviewer-result.component.scss']
})
export class ViewInterviewerResultComponent implements OnInit {

...
@Component({
  selector: 'app-scholarship-interview-application',
  templateUrl: './scholarship-interview-application.component.html',
  styleUrls: ['./scholarship-interview-application.component.scss']
})
export class ScholarshipInterviewApplicationComponent implements OnInit {

...
@Component({
  selector: 'app-scholarship-section-interview-result',
  templateUrl: './scholarship-section-interview-result.component.html',
  styleUrls: ['./scholarship-section-interview-result.component.scss'],
  animations: [
    trigger(
      'enterAnimation', [
        transition(':enter', [
...
export class ScholarshipSectionInterviewResultComponent implements OnInit {

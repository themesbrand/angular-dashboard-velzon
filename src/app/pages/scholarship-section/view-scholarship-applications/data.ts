    ...
    applicationTableDate : [
        {
            ...
            action: 'red',
            applicationStatus : [
              { stage : 'Submission of Application', status : 'Submit', data : '2022-05-06'},
              { stage : 'Initial Screening', status : 'Pending', data : ''},
              { stage : 'Employer Screening', status : 'Pending', data : ''},
              { stage : 'OMSB Committee Review', status : 'Pending', data : ''},
              { stage : 'Review of Acceptance', status : 'Pending', data : ''},
              { stage : 'OMSB Final Screening', status : 'Pending', data : ''},
              { stage : 'Sponsor Final Approval', status : 'Pending', data : ''},
              { stage : 'Finance & Scholarship Qara', status : 'Pending', data : ''},
            ]
        },
        {
            ...
            status : 'Eligible & submitted for Initial Employer screening',
            action: 'green',
            applicationStatus : [
              { stage : 'Submission of Application', status : 'Submit', data : '2022-05-06'},
              { stage : 'Initial Screening', status : 'Eligible & submitted for Initial Employer screening', data : '2022-05-15'},
              { stage : 'Employer Screening', status : 'Pending', data : ''},
              { stage : 'OMSB Committee Review', status : 'Pending', data : ''},
              { stage : 'Review of Acceptance', status : 'Pending', data : ''},
              { stage : 'OMSB Final Screening', status : 'Pending', data : ''},
        ...
        },
        {
            ...
            status : 'Initial Approval by Employer & submitted for OMSB Review (shortlisted for interview)',
            action: 'green',
            applicationStatus : [
              { stage : 'Submission of Application', status : 'Submit', data : '2022-05-06'},
              { stage : 'Initial Screening', status : 'Eligible & submitted for Initial Employer screening', data : '2022-05-15'},
              { stage : 'Employer Screening', status : 'Initial Approval by Employer & submitted for OMSB Review (shortlisted for interview)' , data : '2022-05-18'},
              { stage : 'OMSB Committee Review', status : 'Pending' , data : ''},
              { stage : 'Review of Acceptance', status : 'Pending' , data : ''},
              { stage : 'OMSB Final Screening', status : 'Pending' , data : ''},
              { stage : 'Sponsor Final Approval', status : 'Pending' , data : ''},
        ...
        {
            fullName : 'Yousuf Mahmood Mahfoudh',
            program :  'Anaesthesia',
            programType : 'Value 1',
            sponsoredBy : 'OMSB',
            email : 'Khan@email.com',
            contactNumber : '+9689743687',
            blsExpiryDate : '2025-12-26',
            aclsExpiryDate : '2025-05-05',
            status : 'Provisionally Approved by OMSB – pending obtaining acceptance letter',
            action: 'green',
            applicationStatus : [
              { stage : 'Submission of Application', status : 'Submit', data : '2022-05-06'},
              { stage : 'Initial Screening', status : 'Eligible & submitted for Initial Employer screening', data : '2022-05-15'},
              { stage : 'Employer Screening', status : 'Initial Approval by Employer & submitted for OMSB Review (shortlisted for interview)', data : '2022-05-18'},
              { stage : 'OMSB Committee Review', status : 'Provisionally Approved by OMSB – pending obtaining acceptance letter', data : '2022-06-02'},
              { stage : 'Review of Acceptance', status : 'Pending' , data : ''},
              { stage : 'OMSB Final Screening', status : 'Pending' , data : ''},
              { stage : 'Sponsor Final Approval', status : 'Pending' , data : ''},
              { stage : 'Finance & Scholarship Qara', status : 'Pending' , data : ''},
        ...
        {
            fullName : 'Abdel Maddali',
            program :  'Anaesthesia',
            programType : 'Value 1',
            sponsoredBy : 'OMSB',
            email : 'Abdel@email.com',
            contactNumber : '+968993687',
            blsExpiryDate : '2022-02-26',
            aclsExpiryDate : '2023-06-05',
            status : 'Acceptance Reviewed & submitted for final approval',
            action: 'green',
            applicationStatus : [
              { stage : 'Submission of Application', status : 'Submit', data : '2022-05-06'},
              { stage : 'Initial Screening', status : 'Eligible & submitted for Initial Employer screening', data : '2022-05-15'},
              { stage : 'Employer Screening', status : 'Initial Approval by Employer & submitted for OMSB Review (shortlisted for interview)', data : '2022-05-18'},
              { stage : 'OMSB Committee Review', status : 'Provisionally Approved by OMSB – pending obtaining acceptance letter', data : '2022-06-02'},
              { stage : 'Review of Acceptance', status : 'Acceptance Reviewed & submitted for final approval', data : '2022-06-10'},
              { stage : 'OMSB Final Screening', status : 'Pending', data : ''},
              { stage : 'Sponsor Final Approval', status : 'Pending', data : ''},
              { stage : 'Finance & Scholarship Qara', status : 'Pending', data : ''},
            ]
        },
        {
            ...
            blsExpiryDate : '2022-02-26',
            aclsExpiryDate : '2023-06-05',
            status : 'Submitted to Sponsor for final approval',
            action: 'green',
            applicationStatus : [
              { stage : 'Submission of Application', status : 'Submit', data : '2022-05-06'},
              { stage : 'Initial Screening', status : 'Eligible & submitted for Initial Employer screening', data : '2022-05-15'},
              ...
              { stage : 'OMSB Committee Review', status : 'Provisionally Approved by OMSB – pending obtaining acceptance letter', data : '2022-06-02'},
              { stage : 'Review of Acceptance', status : 'Acceptance Reviewed & submitted for final approval', data : '2022-06-10'},
              { stage : 'OMSB Final Screening', status : 'Submitted to Sponsor for final approval', data : '2022-06-15'},
              { stage : 'Sponsor Final Approval', status : 'Pending', data : ''},
              { stage : 'Finance & Scholarship Qara', status : 'Pending', data : ''},
            ]
        },
        {
          ...
          applicationStatus : [
            ...
            { stage : 'Review of Acceptance', status : 'Acceptance Reviewed & submitted for final approval', data : '2022-06-10'},
            { stage : 'OMSB Final Screening', status : 'Submitted to Sponsor for final approval', data : '2022-06-15'},
            { stage : 'Sponsor Final Approval', status : 'Approved by Sponsor', data : '2022-06-20'},
            { stage : 'Finance & Scholarship Qara', status : 'Pending', data : ''},
          ]
      },
        {
            ...
            applicationStatus : [
              ...
              { stage : 'OMSB Final Screening', status : 'Submitted to Sponsor for final approval', data : '2022-06-15'},
              { stage : 'Sponsor Final Approval', status : 'Approved by Sponsor', data : '2022-06-20'},
              { stage : 'Finance & Scholarship Qara', status : 'Create Qarar', data : '2022-07-01'},
            ]
        },

...
@Component({
  selector: 'app-applicant-recidency-program-applications-view',
  templateUrl: './applicant-recidency-program-applications-view.component.html',
  styleUrls: ['./applicant-recidency-program-applications-view.component.scss']
})
export class ApplicantRecidencyProgramApplicationsViewComponent implements OnInit {
